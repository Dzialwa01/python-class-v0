...
def greatest_population(lst):
    ...
    for dict1 in lst:
        if len(greatest) == 0:
           greatest = dict1 
        elif dict1["population"] > (greatest["population"]): # to compare dictionaries and store the country with the highest population
         greatest = dict1

    return greatest["name"] # returning the name of the country
